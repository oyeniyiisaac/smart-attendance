...
const AdminSideBar = ({ isOpen }) => {
  ...
  return (
    ...
    <>
      <aside
        className={`bg-[#eef5f7] hidden lg:flex fixed top-0 left-0 h-[100vh] p-4 border-r border-[#bfc9bf] flex flex-col justify-between transition-all duration-300 z-20 ${isOpen ? "w-[300px]" : "w-[80px]"}`}
      >
