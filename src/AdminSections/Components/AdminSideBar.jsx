...
const AdminSideBar = ({ isOpen }) => {
    ...
    return (
        ...
        <aside className={`bg-[#eef5f7] fixed top-0 left-0 h-[100vh] p-4 border-r border-[#bfc9bf] flex flex-col justify-between transition-all duration-300 z-20 ${isOpen ? 'w-[300px]' : 'w-[80px]'}`}>

            {/* TOP GROUP: Logo Header + Navigation Menus */}
            <div className="flex flex-col w-full">
                <h2 className={`text-xl font-bold text-[#0a643a] mb-6 whitespace-nowrap overflow-hidden transition-all duration-300 ${isOpen ? 'opacity-100' : 'opacity-0'}`}>
                ...
                <div className='flex flex-col gap-6 mt-6 text-lg text-[#3f4941] w-full'>
                    ...
                    >
                        <span className="material-symbols-rounded" style={iconStyle}>dashboard</span>
